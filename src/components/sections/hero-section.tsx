...
export function HeroSection({ dict }: HeroSectionProps) {
  return (
    <section className="relative mx-auto flex max-w-7xl flex-col items-center overflow-hidden px-4 pt-20 pb-32 text-center md:px-6 md:pt-32 md:pb-40">
      ...
      <div className="absolute bottom-0 left-0 -z-10 h-[600px] w-[600px] -translate-x-1/3 translate-y-1/4 rounded-full bg-blue-500/5 blur-[100px]"></div>
      ...
      <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-20">
        <div className="relative z-10 order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
          ...
          <h1 className="from-foreground to-foreground/70 mb-6 bg-gradient-to-b bg-clip-text text-4xl leading-[1.1] font-bold tracking-tighter text-balance text-transparent sm:text-5xl md:text-7xl">
            {dict.home.title} <br />
          ...
          <div className="flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row">
            <Link
              href="/create"
              className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary/25 group flex w-full items-center justify-center gap-2 rounded-full px-8 py-3.5 font-semibold shadow-lg transition-all sm:w-auto"
            >
